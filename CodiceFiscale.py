...
cognome         = input("Cognome: ").lower()
data_nascita    = input("Data di nascita (gg/mm/aaaa): ").lower()
comune          = input("Comune di nascita: ").lower()
sesso           = input("Sesso (m/f): ").lower()
...
codice_fiscale = codice_fiscale + codiceCF
